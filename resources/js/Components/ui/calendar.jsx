...
function Calendar({
  ...
  return (
    (<DayPicker
      ...
      className={cn("shadow-md p-3", className)}
      classNames={{
        ...
        nav_button_previous: "absolute left-1 text-ForestGreen",
        nav_button_next: "absolute right-1 text-ForestGreen",
        ...
        day_selected:
          "bg-ForestGreen text-slate-50 hover:bg-ForestGreen hover:text-slate-50 focus:bg-ForestGreen focus:text-slate-50 dark:bg-slate-50 dark:text-ForestGreen dark:hover:bg-slate-50 dark:hover:text-ForestGreen dark:focus:bg-slate-50 dark:focus:text-ForestGreen",
        day_today: "font-semibold text-ForestGreen",
        day_outside:
